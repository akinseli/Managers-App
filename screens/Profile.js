...
const Profile = (props) => {
    ...
    console.log(_id)
    const deleteEmploye = () => {
        fetch("https://managersappserver.herokuapp.com/delete", {
            method: "post",
            headers: {
    ...
    return (
        <View style={styles.root}>
            ...
            <View style={{ alignItems: 'center' }}>
                <Image
                    style={{ width: 140, height: 140, borderRadius: 140 / 2, marginTop: -50 }} source={{ uri: picture }}
                />
            </View>
            ...
            <View style={{ flexDirection: 'row', justifyContent: 'space-around', }}>
                ...
                <Button icon="delete" theme={theme} mode="contained" onPress={() => deleteEmploye()}>Delete employee</Button>
            </View>
        </View>
    )
}
